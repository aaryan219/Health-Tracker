...
describe('HomeComponent', () => {
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('h1')?.textContent).toContain('Take care, Live');
  });
  ...
  it('should render the heading', () => {
    ...
    expect(heading?.textContent).toContain('Take care, Live');
  });
  ...
  it('should render the description', () => {
    ...
    expect(description?.textContent).toContain('Baby Gymnasi');
  });
